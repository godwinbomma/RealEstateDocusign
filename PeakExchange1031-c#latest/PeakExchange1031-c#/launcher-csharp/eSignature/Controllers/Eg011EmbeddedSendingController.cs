...
namespace DocuSign.CodeExamples.Controllers
{
    ...
    public class Eg011EmbeddedSendingController : EgController
    {
        ...
        public Eg011EmbeddedSendingController(DSConfiguration config, IRequestItemsService requestItemsService, IDocumentService documentService)
        ...
        // ***DS.snippet.0.start
        private string DoWork(string signerEmail, string signerName, string accessToken, string basePath,
            string accountId, string startingView, string dsReturnUrl)
        {
            ...
            controller2 = new Eg002SigningViaEmailController(Config, RequestItemsService, DocumentService);
            EnvelopeSummary results = controller2.DoWork(signerEmail, signerName, Userid, DocumentID);
        ...
        [HttpPost]
        public IActionResult Create(string signerEmail, string signerName, string startingView)
        {
            // Data for this method
            // signerEmail 
            // signerName
            ...
            string redirectUrl = DoWork(signerEmail, signerName, accessToken, basePath,
