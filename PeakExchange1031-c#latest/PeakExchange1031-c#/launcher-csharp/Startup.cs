    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           // services.AddScoped<IUnitofWork, UnitofWork>();
            ...
            services.AddDbContextPool<RealEstateLocalContext>(options =>
            options.UseMySQL(Configuration.GetValue<string>("ConnectionStrings:RealEstateDev"),
            Migration => Migration.MigrationsAssembly("RealEstate.Data")));
